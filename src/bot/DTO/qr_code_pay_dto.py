...
class QrPayCodeDTO:
    def __init__(self, qr_code: str, server_id: str, channel_id: str, message_id: str, ngay_tao: datetime):
    ...
    def __str__(self) -> str:
        return f"QrPayCodeDTO(qr_code={self.__qr_code} server_id={self.__server_id} channel_id={self.__channel_id} message_id={self.__message_id} ngay_tao={self.__ngay_tao})"

    def __eq__(self, other: object) -> bool:
        if not isinstance(other, QrPayCodeDTO):
            return NotImplementedType
        return self.__qr_code == other.__qr_code and \
               self.__server_id == other.__server_id and \
